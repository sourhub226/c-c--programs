...
class tollBooth
{
	...
	public:
		...
		void display()
		{
			...
			cout<<"Total cash collected: "<<amount<<endl;
		}
};
...
int main()
{
	tollBooth c;
	char ch;
	cout<<"Press p for paying car"<<endl<<"Press n for non-paying car"<<endl<<"Press e to exit"<<endl;
	while(1)
	{
		...
		switch(ch)
		{
			...
			case 'e':
				...
				exit(1);
			default:
				cout<<"Please enter an appropriate key."<<endl;	
		}
	}
}
